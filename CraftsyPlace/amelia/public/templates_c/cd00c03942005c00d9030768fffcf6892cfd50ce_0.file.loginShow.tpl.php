<?php
/* Smarty version 4.3.4, created on 2025-01-19 13:00:49
  from 'D:\Instalki\XAMPP\htdocs\amelia\app\views\loginShow.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_678ce971985b54_40824046',
...
function content_678ce971985b54_40824046 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
login" method="post" style="width: 300px; padding: 20px; border: 1px solid #ccc; border-radius: 8px; background-color: #f9f9f9; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
        ...
        <div style="text-align: center;">
            <input type="submit" name="zaloguj" value="Login" style="padding: 10px 20px; border: none; border-radius: 4px; background-color: #007BFF; color: white; font-weight: bold; cursor: pointer;">
        </div>
    </form>
</div>
