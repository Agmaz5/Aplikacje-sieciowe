...
<html lang="pl">
    <head>
        ...
        <meta name="description" content="{$page_description|default:'Twój sklep z rękodziełem i unikalnymi przedmiotami'}">
    ...
    <body>
        ...
        <div class="pure-menu pure-menu-horizontal">
            <a href="#" class="pure-menu-heading">{$page_title|default:"CraftsyPlace"}</a>
        ...
        <div class="banner">
            <h1 class="banner-head">
                {$page_header|default:"Witaj w CraftsyPlace!"}
            </h1>
        </div>
